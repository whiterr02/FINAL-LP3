<script lang="ts">
	...
	type Props = { form: SuperValidated<Infer<SchemaProducto>>; producto: Producto };
	let { form: preForm, producto }: Props = $props();
...
<Dialog.Root bind:open>
	...
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			<Dialog.Title>Editar Producto {producto.marca} {producto.modelo}</Dialog.Title>
			<Dialog.Description>
				Editar Producto, haz click en aceptar cuando termines.
			</Dialog.Description>
		</Dialog.Header>
